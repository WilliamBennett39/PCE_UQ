...
def sample_T_pn(N_samples = 1024):
    ...
    a2 = (np.array(target_coeffs_pn))/8
    ...
    save_T_samples(samples_target, 'target_Pn_samples.hdf5')
    save_T_samples(samples_drive, 'drive_Pn_samples.hdf5')
...
def sample_T_he(N_samples = 1024):
    ...
    save_T_samples(samples_all, 'all_He_samples.hdf5')
    save_T_samples(samples_target, 'target_He_samples.hdf5')
    save_T_samples(samples_drive, 'drive_He_samples.hdf5')
