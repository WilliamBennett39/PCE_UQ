...
def numba_splev_list(x, t, c, k, equi_spaced, dx):
...
# xs = np.linspace(0, 1.11104, 500)
# sol = solve_marshak(7/2)
# t, c, k, equi_spaced, dx =   custom_splrep(np.flip(sol.t), np.flip(sol.y[0]), k=3)
# interp_ob = numba_splev_list(xs, t, c, k, equi_spaced, dx)
